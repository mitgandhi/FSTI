...
CPressure::CPressure()//Constructor
{
	...
	Pump.nrevolutions = abs(myinput.data.lubrication_module.n_lubrication_revolutions);//ONLY FOR INTERNAL USE Coupled Caspar will have its own, separate pressure module!
