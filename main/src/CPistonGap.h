...
class CPistonGap
{
	...
	struct sForcesPistonGap
	{
		...
		double FSKx;            // Reaction forcee on X
		double FSKy;            // Reaction force on Y
		double FAKz;            // Total apllied force on piston
		double FaK;             // inertia force
		double Fwk;             // Centrifugal force 
		double FDK;            // Pressure force
	...
	void PistonReynoldsCalcCoefficientsMG(void);
	void PistonReynoldsMG(void);
	void PistonReynoldsCalcResidualMG(int l);
	

	//----------------------DECLARATION OF GAP FUNCTIONS----------------------//
	void PistonGap(vector<double> &xp,vector<double> &vp);
	//Main function to call Piston gap calculations
	void PistonGapJacobian(vector<double> &xp,vector<double> &vp,vector<double> &dF);
	...
	void PistonCalcvK_inclined(void);
	//Calculate piston stroke	
	void PistonCalcsK_inclined(void);
	...
	//Calculate piston gap height
	void PistonCalcdht(vector<double> &vp);	
	...
	//Solve piston gap Reynolds Equation
	void PistonReynoldsCalcCoefficientsGS(void);
	//Solve piston gap Reynolds Equation
	...
	void PistonCalcExternalForces_inclined_piston(void);		//Calculate piston external forces	for inclined piston
